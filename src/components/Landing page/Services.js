    ...
    >
      ...
      >
        ...
        <Text mb="6" opacity="0.8">
          ...
          never run out of customers and not run at loss. We are trusted by many
          companies to provide them with funding,employee and mentors.
        </Text>

        <Button width="100px" size="sm" colorScheme="teal">
          CONTACT US
        </Button>
      </Flex>
    </Flex>
